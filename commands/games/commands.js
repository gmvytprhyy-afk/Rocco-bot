  ...
  },
  {
    ...
    async execute(interaction) {
      ...
      const embed = new EmbedBuilder().setColor(0x5865F2).setTitle('Rock Paper Scissors')
        .addFields({ name: 'You', value: emojis[player as 'rock'|'paper'|'scissors'] + ' ' + player, inline: true }, { name: 'Me', value: emojis[bot as 'rock'|'paper'|'scissors'] + ' ' + bot, inline: true }, { name: 'Result', value: result });
      await interaction.reply({ embeds: [embed] });
    }
  },
  {
